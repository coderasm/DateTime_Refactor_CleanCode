 ...
 *
 * --------------------
 * org.jfree.date.SpreadsheetDate.java
 * --------------------
 * (C) Copyright 2000-2005, by Object Refinery Limited and Contributors.
 *
 ...
 * Contributor(s):   -;
 *
 * $Id: org.jfree.date.SpreadsheetDate.java,v 1.8 2005/11/03 09:25:39 mungady Exp $
 *
 * Changes
 * -------
 * 11-Oct-2001 : Version 1 (DG);
 * 05-Nov-2001 : Added getDescription() and setDescription() methods (DG);
 * 12-Nov-2001 : Changed name from ExcelDate.java to org.jfree.date.SpreadsheetDate.java (DG);
...
public class SpreadsheetDate extends DayDate {
    ...
    public SpreadsheetDate(final int serial) {
        ...
        if ((serial >= SERIAL_LOWER_BOUND) && (serial <= SERIAL_UPPER_BOUND)) {
            ...
            throw new IllegalArgumentException(
                "org.jfree.date.SpreadsheetDate: Serial must be in range 2 to 2958465.");
        }
     ...
     * 
     * @param other  the other object (usually another org.jfree.date.DayDate).
     * 
    ...
    /**
     * Returns true if this org.jfree.date.DayDate is within the specified range (caller
     ...
     *
     * @return <code>true</code> if this org.jfree.date.DayDate is within the specified
     *         range.
     */
    public boolean isInRange(final DayDate d1, final DayDate d2,
                             final int include) {
